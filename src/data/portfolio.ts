...
export const portfolio: Portfolio = {
  ...
  brand: {
    ...
    navCta: { label: 'Fale comigo', href: '#contact-intro' },
  },
  navigation: [
    ...
    { label: 'Contato', href: '#contact-channels' },
  ],
  hero: {
    ...
    contactCta: { label: 'Iniciar Conexão', href: '#contact-intro' },
    ...
    items: [
      {
        ...
        imageSrc:
          '/bellabot/Blue%20Yellow%20Modern%20Future%20Technology%20Video.jpg',
        imageOpacity: 0.2,
        detail: projectDetails.bellabot,
      },
      {
        slug: 'smart-key',
        title: 'Smart Key',
